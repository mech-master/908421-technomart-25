function dataCounterIncrease(counterClass, attributeName) {
	...
	return function(event){
		if (counterClass == "toolbar-cart") {
			var modalCartAdd = document.querySelector(".view-port-cart_add");
...
function setEventWriteUsFormOpen() {
	var buttonWriteUs = document.querySelector(".button-write_us");
	if (buttonWriteUs) {
		buttonWriteUs.addEventListener("click", 
			function(event) {
			var modalWriteUs = document.querySelector(".view-port-write_us");
			event.preventDefault();
